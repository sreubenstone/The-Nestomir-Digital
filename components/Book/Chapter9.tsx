    ...
    return (
      <View>
        ...
        <Text style={BookStyles.bookFont}>
          ...
          <Text style={{ fontFamily: "gelasibro-italic" }}>Boulevard de Tanger</Text>. The locals turned their heads to examine the boy dressed in a long grey robe and the peculiar hooded figure but quickly continued on with their business.{"\n"}
          ...
          a camel in his wake. <Text style={{ fontFamily: "gelasibro-italic" }}>Yeah, this isn't Wisconsin</Text>. They approached an old two story apartment building. The sign 618 Tangers sat in front of it. Dendro pulled open the old wooden doors
