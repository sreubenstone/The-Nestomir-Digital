    ...
    return (
      <View>
        ...
        <Text style={BookStyles.bookFont}>
          A crimson eyed demon seized Jake's legs in the middle of a rainstorm. He was shackled to a metal floor and he felt himself sliding. Then a pair of panther-like claws seized his arms. He slowly opened his eyes. His optical nerves turned back
          on, ready to process information from the outside, as Dendro's powerful hands shook him. "Wake up, kid," the Gobrahim warrior said. "We have a big day ahead of us..it is your first training day."{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>Are you serious?</Text> Jake rolled over to look at the cyberpunk clock. It was 5:01 AM. "Get off of me, bro," Jake complained as he shut his eyes again, but he continued to feel Dendro's
          ...
          {"\n"}His sleepy mind was tempted to snap back at him. "Alright, I'll be up in three minutes", Jake mumbled into the pillow.{"\n"}
          {"\n"}He heard Dendro leave the room.{"\n"}
          {"\n"}Jake kept his eyes half-open, staring at the clock, with the covers pulled tight over him. He slowly forced himself out of his comfortable cocoon. He could hear Dendro opening up drawers and closing cupboards down the hall.{"\n"}
          {"\n"}He got dressed in warm sweatpants and a white Adidas t-shirt that he found in the dresser. Zimmer certainly had done a nice job keeping this place stocked with clothing and supplies. Jake still had no idea how Zimmer knew his clothing
          size. He threw on his silver chain and exited his room.{"\n"}
          {"\n"}"Where are we going?"Jake said, still half awake, as he fumbled into the main section of the apartment.{"\n"}
          ...
          {"\n"}Jake took down the authentic Moroccan soup, and soon after followed the warrior out the door. The streets of Casablanca were quiet as the sun's corona crept over the horizon. They walked south, bobbing and weaving through a series of
          narrow streets until they arrived at a larger street named <Text style={{ fontFamily: "gelasibro-italic" }}>Rue Attabari</Text>. A few street cart vendors were setting up their stands and a couple of motorbikes passed by them.{"\n"}
          ...
          {"\n"}
          {"\n"}A bit further down Rue Attabari, sitting against a barbed wire fence, was a dilapidated hut constructed of broken aluminum panels. A middle aged Moroccan woman lay on the ground; the white hijab on her head rested against the
          makeshift shelter. Two small children, a girl, and a boy, lay in her arms. Jake could see a look of desperation in her eyes. He felt a pit in his stomach. How could a mother care for her children like this?{"\n"}
          ...
          {"\n"}"I think we must push ourselves every day to try new things. To discover a place, in our minds, where our heart's desire and creative drive become in sync. We must make time for this each day, no matter our age, or position in life,"
          Dendro said.{"\n"}
          {"\n"}They walked along the cracked side walk in silence for a few moments.{"\n"}
          {"\n"}"So you're saying we should always be learning new things, like coding?" Jake asked.{"\n"}
          {"\n"}"Not just coding. But yes. Learning new things is key to discovering our passion. Whether it be pushing ourselves to learn how to draw, write music, code, or build robots, learning new things is what we Naronian's feel to be the core
          ...
          {"\n"}"We didn't learn this in school. I guess it would be cool to find something to learn that you cared that much about." Flashes of his father and grandfather ran through his mind. "But can we all really find it?" Jake asked.{"\n"}
          ...
          {"\n"}"What else do we need?" Jake asked. "What is bigger than passion?"{"\n"}
          ...
          {"\n"}They continued walking. Jake pondered Dendro's statement for a moment. "What do you mean by that?"{"\n"}
          {"\n"}"There are a few famous examples to portray this understanding. But one in particular has always stuck in my head." A street vendor pushed his spice cart in between them. "Are you familiar with the American inventor Henry Ford?"{"\n"}
          {"\n"}"Of course. He invented the car. Or the assembly line right? How do you know about Henry Ford?" Jake asked.{"\n"}
          {"\n"}"Our government is fascinated with the histories of our enlightened worlds. We study famous inventors from many planets. And yes, I know he is the creator of your assembly line."{"\n"}
          {"\n"}"When Mr. Ford first developed his passion for moving humans around—many people at the time would have said that his focus should have been on improving the horse driven carriage. Some may have even thought him crazy to pursue a
          mechanized vehicle. But Henry Ford had the unique ability to separate problem from solution. He recognized that the world's problem was not the horse driven carriage—it was the fact human beings could not get around efficiently. By placing
          our problem and our solution into two distinct spaces in our minds<Text style={{ fontFamily: "gelasibro-italic" }}>,</Text> we can achieve great things."{"\n"}
          ...
          get passionate about an issue, our passion has the tendency to excite our emotions so much that we skip critical steps, like separating problem from solution. We must relish in our positive emotions, and passions, but we must always push
          ourselves to have the discipline, to understand the problem that stemmed our passion, before we think about ways to solve it."{"\n"}
          ...
          {"\n"}"I guess that does make sense. But I've never thought about it so critically before," Jake said.{"\n"}
          {"\n"}"We need great teachers to become aware of these things. A great educator of mine once said: 'When building anything meaningful, steps zero to three matter much more than step three to sixty.' Once we forget to perform these first few
          steps of distilling our problem from our solution, everything else loses its grace."{"\n"}
          {"\n"}"So interesting," Jake said. He had never thought about things this way.{"\n"}
          {"\n"}Dendro turned onto a narrow side street named <Text style={{ fontFamily: "gelasibro-italic" }}>Rue de La Paix</Text>. The front of the block was crowded with art dealers selling Moroccan inspired crafts and paintings. They walked
          around them and approached a storefront with a red awning. <Text style={{ fontFamily: "gelasibro-italic" }}>Tropicana Hookah Lounge,</Text> the sign read. Dendro knocked on the glass window. Soon Jake saw Zena approach from inside.{"\n"}
          ...
          {"\n"}A couch and a wooden coffee table sat directly in front of them, and on the far right side of the room was a desk. Zimmer sat in a leather chair behind it, glaring at a monitor. He was wearing a brown military hoodie. His wolfish face
          ...
          {"\n"}Dendro leaned forward. "Yes, son. I pray that news will reach us that will allow us to get you back to your family." He paused for a moment. "We are dealing with a complex war which I fear is being fought on two fronts," he said. He
          turned to Zimmer. "<Text style={{ fontFamily: "gelasibro-italic" }}>Now</Text> I see clearly that Vostluka will push hard to take advantage of this momentum shift. But I worry that we are being manipulated by another, far more nefarious
          scheme." He paused and rubbed his chin, deep in thought.{"\n"}
          {"\n"}"Who is Vostluka?" Jaked asked.{"\n"}
          {"\n"}"Jetubro Vostluka, the man that inherited the Venthum throne—The Vostluka line has maintained totalitarian rule over planet Venthe for over a millennia," Dendro uttered. "They have suppressed their people with their ruthless ideology
          that his father, Doglav Vostluka, and his father before him, helped create. It is called <Text style={{ fontFamily: "gelasibro-italic" }}>The New Doctrine</Text>: only a small portion shall thrive, the rest must live mentally captive. The
          New Doctrine preaches that learning and prosperity can not be spread out or democratized. The Vostlukas torture Venthum citizens who have managed to rebel."{"\n"}
          ...
          {"\n"}"I do not know. My gut has warned me of this for a long time. I believe they are after a deeper understanding of The <Text style={{ fontFamily: "gelasibro-italic" }}>Utma—our</Text> deer understanding of The Utma—understandings our
          great spiritual leaders and scientists have obtained and cultivated over thousands of years of painstaking effort. This is one area their culture could never excel. But I do not know how it will be done."{"\n"}
          ...
          {"\n"}"Enough talk of enemies and war," Dendro said. "These battles will be fought in due time. Today we are here to give you the opportunity to train, Earthling. You demonstrated{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>Foresight</Text> with no training. That is not something any of us can easily ignore. It has sparked a deep intrigue in Zimmer, Zena, and I, and I'm sure it would in our spiritual leaders. We
          are encouraging you to take your learnings a bit further today by stepping onto this mat. Are you up for that, son?"{"\n"}
          ...
          {"\n"}"Well, to really understand The Function, we must first understand The Utma. The Utma believes in efficiency. She believes in efficiency because we can not achieve our creative purpose unless we build things in an{" "}
          ...
          {"\n"}"Ok, but is it? What is a function actually?" Jake asked. "I get it...it's like instructions that can be repeated....but what does that mean?"{"\n"}
          {"\n"}"The best way to demonstrate The Function is not with a textbook explanation, but with a real world example. The one that comes to mind is through something that happens in the coding world every day: sending notifications to us in
          the apps we know and love, in both of our galaxies"{"\n"}
          ...
          {"\n"}Jake's mind began to wander. This information was so foreign, but so were the alien's in the room with him. He spotted Dendro and Zimmer watching intently from the side of the mat.{"\n"}
          ...
          {"\n"}Zena shook her head in approval. "Likes, new messages, new emails, new comments are good examples of things that generate notifications. In industry, coders spend a lot of time making sure notifications get sent efficiently. But
          sending a notification is not the simplest procedure in the world. For example, if we want notifications to display on your phone's screen properly, it requires the coder to get approval, in your planetary case, from the Android or Apple
          app store. There are other complex steps to ensure the notification gets to your phone, like properly tracking, routing, and saving them long term. We need to perform all of these steps for{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>every single</Text> notification we send."{"\n"}
          {"\n"}Zena walked to the back of the room, and pulled something off the wall. As Jake watched the object float across the mat he realized it was a whiteboard.He watched it float toward him
          <Text style={{ fontFamily: "gelasibro-italic" }}>. A floating whiteboard, now I've seen it all.</Text>
          {"\n"}
          ...
          board. {"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}></Text>Step 1:<Text style={{ fontFamily: "gelasibro-italic" }}></Text> Find the user's phone number{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}></Text>Step 2:<Text style={{ fontFamily: "gelasibro-italic" }}></Text> Get permission from iOS or Android store to send the notification{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}></Text>Step 3:<Text style={{ fontFamily: "gelasibro-italic" }}></Text> Check security permissions{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}></Text>Step 4:<Text style={{ fontFamily: "gelasibro-italic" }}></Text> Send the message "You have received a new alert" to the correct user's phone.{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}></Text>Step 5:<Text style={{ fontFamily: "gelasibro-italic" }}></Text> Log the notification (make a long term record of it){"\n"}
          {"\n"}"So here are the typical steps required when sending a notification to a user. To make this lesson crystal clear, let's imagine a coder named Angelica has just begun to build her her dream social networking app. She's thought about it
          for a while, and the project is a totally blank slate. The first thing she might do is build out the first feature in the app, say, enabling users to upload pictures to their newsfeed. Angela writes the code to allow her users to upload
          pictures. After this is working, Angelika wants her users to be able to add comments to pictures. She spends some time working on this feature and completes it. After this comments feature is working, Angelika thinks to herself,{" "}
          ...
          {"\n"}"So, Angelika codes in the five steps above that are necessary to send notifications. When coded out, they are long, complex steps that require many hours of study to implement, but they are necessary to bring her product to life, so
          she does it. <Text style={{ fontFamily: "gelasibro-italic" }}>Yes! My friends will now get notifications any time someone comments on their pictures. Amazing!</Text> Next, Angelika gets a few close friends to test the app out, and{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>wha-la,</Text> they receive notifications whenever someone comments on their photo. Angelika feels very proud.{"\n"}
          ...
          {"\n"}"Angelika thinks: <Text style={{ fontFamily: "gelasibro-italic" }}>you know she's right.</Text> So Angelika goes on her computer to begin working on the new <Text style={{ fontFamily: "gelasibro-italic" }}>likes</Text> feature, but
          ...
          {"\n"}"Angelika, at this moment, like many coders before her, might assume this:{" "}
          ...
          {"\n"}"It was extremely difficult to manage. And as a result, coders like Angelika discovered that they could use <Text style={{ fontFamily: "gelasibro-italic" }}>functions</Text> to solve this problem. Angelika studied functions rigorously
          ...
          <Text style={{ color: "#0C2443", fontFamily: "code" }}>
            <Text style={{ fontFamily: "gelasibro-italic" }}></Text>def<Text style={{ fontFamily: "gelasibro-italic" }}></Text>
          </Text>{" "}
          keyword. Next, we give a unique name to the function; it can be just about any name we choose. Then we place a colon <Text style={{ color: "#0C2443", fontFamily: "code" }}>:</Text> at the end of the{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>function name</Text> to complete the <Text style={{ fontFamily: "gelasibro-italic" }}>function header</Text>. Angelika would probably have defined her notification function header like this:
        </Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          ...
          function's code block, or <Text style={{ fontFamily: "gelasibro-italic" }}>function body</Text>. I will write in five dummy instructions here —- these steps are obviously not real code, but I'm placing them here to demonstrate where the
          real Python instructions would go. I've used <Text style={{ fontFamily: "gelasibro-italic" }}>Python comments</Text> to document what the intent of each step would be.
        </Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}"Ok, I get that now," Jake said. "This is the function, and these are where the steps would go."{"\n"}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}Zena nodded. "Yes, it happens to the best of us, even Angelika. But, just like that —- once Angelika, and coders alike, discovered the reusable power of functions, there was no going back. They could write and maintain functions in
          one place, and use these instructions wherever they so desired, never having to rewrite them again. Functions, these atomic units of organizing instructions, are critical to everything coders do."{"\n"}
          {"\n"}Zena pushed the board gently; it floated slowly backward. She stretched her shoulders and triceps.{"\n"}
          ...
          {"\n"}"Yes, for example, what if Angelika wanted to tweak the message displayed on her user's phones depending on which feature triggered the notification? Right now she's written these five steps of code, but the problem is, every message
          ...
          {"\n"}"Jeez. That's some intense stuff," Jake said.{"\n"}
          {"\n"}"We do not fear the intense," Zena said. She walked back to the white board and pushed it back towards Jake.{"\n"}
          {"\n"}She stepped in front of the board again and said, "Let's take a look at this thing called <Text style={{ fontFamily: "gelasibro-italic" }}>input</Text>. In Python we refer to each input we provide our function as a{" "}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          <Text style={{ color: "#0C2443", fontFamily: "code" }}>
            <Text style={{ fontFamily: "gelasibro-italic" }}></Text>print<Text style={{ fontFamily: "gelasibro-italic" }}></Text>
          </Text>{" "}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}"Yes, essentially. When Angelika triggers the <Text style={{ color: "#0C2443", fontFamily: "code" }}>send_notification</Text> function, she may have wanted to return something to the code following it. What information do you think
        ...
        <Text style={BookStyles.bookFont}>
          ...
          <Text style={{ color: "#0C2443", fontFamily: "code" }}>add</Text>, which takes two parameters a and b. The function has one step. See here.
        </Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          What do you think the result of <Text style={{ color: "#0C2443", fontFamily: "code" }}>sum</Text> will be in <Text style={{ color: "#0C2443", fontFamily: "code" }}>sum = add(2,3)</Text>?{"\n"}
          {"\n"}"2 + 3? So 5?" Jake said.{"\n"}
          {"\n"}Zena shook her head.{"\n"}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}"Yea, it confuses me also. I think Fahrenheit is better," Jake said.{"\n"}
          {"\n"}"I'm not sure which is better. But our ships, and other equipment often need to convert Celsius to Fahrenheit, and visa versa. And we don't want to rewrite the same code a million times. I want you to write me a function that converts
          ...
          {"\n"}Jake stopped the floating board and took up a marker. <Text style={{ fontFamily: "gelasibro-italic" }}>Where do I even start?</Text> He thought. He looked at the blank canvas.{" "}
        ...
        <Text style={BookStyles.bookFont}>
          <Text style={{ fontFamily: "gelasibro-italic" }}>The name is easy. But the steps.</Text> He forced himself to think clearly, even with all three of them watching from their various locations on the mat.{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>We need to take celsius and convert it to fahrenheit. So, we give the function Celcius, and it spits out Fahrenheit. In, out.</Text>
          {"\n"}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}"Nine over five, times celcius, add thirty two," Zena responded quickly.{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>Nine over five, times celcius, add thirty two</Text>. He sketched the equation on the board. His mind cycled through a few options, but he spotted the opportunity to use his input.
        </Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          ...
          <Text style={{ color: "#0C2443", fontFamily: "code" }}>fahrenheit</Text>. What else is needed, if anything?" He looked back at Zena, then he thought of taking a handoff from his quarterback in flag football. The{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>return</Text>. He updated his code once again.
        </Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}"So what now?" Jake asked, as he ran his finger over the marking. <Text style={{ fontFamily: "gelasibro-italic" }}>Yea, my mom is definitely going to kill me.</Text>
          {"\n"}
          ...
          {"\n"}Zena rook her right foot in her hand, bending her leg backwards to stretch out her quadriceps, then continued her circular strut. "You have achieved <Text style={{ fontFamily: "gelasibro-italic" }}>Zegmu</Text>, weapons harnessing."
          When she said this Jake let his axe fall to his side; he watched as it hovered next to him. It stayed in position next to his hip as he rotated his body. {"\n"}
          ...
          {"\n"}"Good. Practice that for a moment." As Zena headed for the shelf, Jake stayed in position, trying to get his body to feel more comfortable. When came back a few moments later carrying a long, curving sword, she gently kicked the back
          ...
          a sort of teleportation, even though we know that is not quite what is occurring. I'm going to come at you slowly." She backed up five paces. "Make an attempt to dodge my strike."{"\n"}
          ...
          teleporting to his right. But as he held the thought in his mind's eye, and stepped forwards, he took an awkward stumble, and almost fell down. He felt embarrassment run through him.{"\n"}
          ...
          <Text style={{ fontFamily: "gelasibro-italic" }}>Woah</Text>. He felt himself being pulled slowly as if time had slowed down. And then Zena was almost instantly in back of him, and he had a clean angle of attack at her back.{"\n"}
          ...
          become aware of where each power sits inside of us, so that they can properly manifest," Dendro had said. When the session was officially complete, Jake stood up, bowed, and lay the axe back into Zena's hands. He changed and met them all
          near the staircase.{"\n"}
          ...
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>An encrypted beeper? What do I need this for?</Text> He placed the object in his pocket, took one last look at the alien dojo, then followed the three of them up the staircase, back onto the
          Casablanca streets.
        </Text>
      </View>
    );
