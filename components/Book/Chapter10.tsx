      ...
      <View>
        ...
        <View style={GlobalStyles.flexCenter}>
          <Image
            ...
            source={{
              uri: `https://i.pinimg.com/originals/81/76/ae/8176ae26e93e67b9da12988e10b83adf.jpg`,
            }}
          />
        </View>
        ...
        <Text style={BookStyles.bookFont}>
          "Make sure you dress suitably. We have to look sharp. And don't take a long shower, kid," Dendro shouted as Jake shuffled down the hall.{"\n"}
          {"\n"}Jake found a towel in the hallway closet, hopped in the shower, finished up, then headed back into his room. He dried his body and hair, then pulled open the closet. He scanned through the alluring items of clothing that were all
          somehow exactly his size. The sharp-looking gray suit hanging to his far right caught his eye.{"\n"}
          ...
          {"\n"}He ran his hands down the soft material of the suit. He put his nose up to it—it smelled like it had been freshly pressed. He threw on a fresh pair of underwear, a white dress shirt, and black dress socks, then pulled the suit off the
          hanger and put it on. He tried to put on a narrow navy tie, but he failed miserably. "Crud", Jake muttered. He combed his straight brown hair to the side, as he often did on fancier occasions, then looked at the orb necklace lying on his
          desk. <Text style={{ fontFamily: "gelasibro-italic" }}>Maybe I'll put it on.</Text> He threw it over his neck, tucked it under his dress shirt, and walked into the living room.{"\n"}
          {"\n"}"Looking sharp," Dendro said. The warrior was fixing his man bun in the mirror by gently patting it down on each side. He had a black suit on that was a bit too small for him (it stretched tightly against his muscled torso and
          shoulders), and shiny black shoes. A moment later, after fixing his precious locks, he threw a black San Diego Padres baseball cap over his head, and tucked his ears underneath it, then turned around to face Jake. "I'm ready to go," he
          said. The bump from the shoulder bandage stuck out quite noticeably.{"\n"}
          {"\n"}"Dendro, I need help with this tie," Jake pleaded.{"\n"}
          {"\n"}Dendro snapped his fingers and signaled for him to come in front of the mirror. He reached his thick Gobrahim hands around Jake's neck. "Haven't done this in a while, not since a Special Ops mission on Argus. Black tie affair." He
          fumbled with the tie for a few moments, then finally made a perfect knot around Jake's neck. "There you go," Dendro said, proudly.{"\n"}
          ...
          {"\n"}They walked out of the apartment, and stepped onto Tanger's street. Jake followed Dendro south as the sun dipped below the horizon on their right. They walked for a short while through the cooler evening air, turning on a few side
          streets, then onto a larger avenue. Dendro looked a bit odd wearing his baseball cap and slightly small suit, but it was not enough to draw undue attention.{"\n"}
          {"\n"}As they walked, they passed by street vendors, soon-to-be bar patrons and restaurant goers, couples, teenagers, french restaurants, cabarets, and wine bars. The pink lights of the neon restaurant signs obscured his vision and the
          Moroccan music emanating from nearby bars reminded him he was not in North America.{"\n"}
          {"\n"}A few blocks later, Dendro turned right onto a side street that was illuminated by newly lit street lanterns. As they walked forward, Jake spotted more neon lights up ahead, and he heard the thumping of dance music; apparently there
          was some serious action at the end of the block.{"\n"}
          ...
          {"\n"}They walked on and soon approached another bar on their right, which had an outdoor seating area set up on the street. On top of the building was a glowing white sign that, in thick black letters, read:{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>Cocktail Lounge</Text>.{"\n"}
          ...
          {"\n"}They stood on top of a shiny black marble floor, staring into a dimly lit room. The bar was directly to their left, and a few people sat there on red velvet bar stools speaking to one another inaudibly. Jake watched curiously as a
          slender blonde woman giggled loudly as she spoke with a man dressed in a dark suit. The rest of the room was lined with red velvet couches—parties of men and women sat on them, drinking and smoking, engaged in lively conversations.{"\n"}
          ...
          with the three alien glyphs, sitting above the peephole.{"\n"}
          {"\n"}Dendro rolled up his sleeve, tapped down on a few numerical keys on his Lithium Radar screen, and then clamped down on the bronze door handle. There was a high pitched beep, and then Jake heard the sound of an air lock opening. The
          door budged open and they stepped inside a tiny room with a black spiral staircase leading down to another floor.{"\n"}
          {"\n"}Jake went first. As he walked nervously down the staircase, he heard the door lock behind them. He ducked down, to protect his head from the curving metal stairs above him, and then twirled around down to the bottom, hitting the
          ground level where he found himself staring at a picture of Frank Sinatra smoking a cigarette. He turned around to face the room; it was smokey and smelled of whiskey, Jasmine tea and tobacco. Polished black and white marble floors extended
          through the space and crystal chandeliers were evenly spaced across the ceiling. A ventilation duct zigzagged in between them. Patrons sat on antique leather couches conversing, drinking and smoking—there was so much smoke in the air it was
          hard to make out the faces.{"\n"}
          ...
          <Text style={{ fontFamily: "gelasibro-italic" }}>Is that a man?</Text> His skin was charcoal grey. <Text style={{ fontFamily: "gelasibro-italic" }}>His shoulders are unusually wide</Text>, Jake thought. He noticed a few other beings next to
          him that took on a similar appearance. They drank an amber liquid from tall crystal glasses as they spoke to one another. As the room's visibility improved, Jake saw more alien figures. A male and female couple with entirely light blue skin
          sat next to each other on one couch. Their ears were pointy, elf-like, and he was stunned to see that these two creatures had no pupils at all; their eyes were a solid greenish-grey.{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>OMG.</Text> As he glanced across the space he got the feeling this was not a standard Moroccan bar, but more of some kind of secret alien lounge.{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>This just gets weirder and weirder. </Text>
          {"\n"}
          ...
          passed tables with more goggle-eyed and blue-elf like aliens, then passed a wall filled with Renaissance and Baroque art, before arriving at a circular leather booth with two beings sitting inside of it.{"\n"}
          ...
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>That looks like a..werewolf...crossed with a man</Text>. As the creature's intimidatingly thick arms wrapped around Dendro, Jake could see the wolf-man's neck bulging with thick veins and
          striated muscle. <Text style={{ fontFamily: "gelasibro-italic" }}>That dude is...really strong</Text>. The wolf-man creature also possessed a black snout; it had black and white fur wrapped around its mouth, wolf-like nose, and eyes. The
          rest of his body had human-like skin, but Jake noticed that his arms had streaks of extremely thick white and gray hair. Then Jake saw the markings on his forearms. <Text style={{ fontFamily: "gelasibro-italic" }}>Who is this guy?</Text>{" "}
          The beast of a man wore light brown military boots, camouflage pants, a tight white shirt that brought out his pecs, and a diamond encrusted dog tag, as well as a silver orb on a separate chain. Jake also caught sight of some kind of bronze
          weapon on his belt line.{"\n"}
          ...
          partner, Zena."{"\n"}
          {"\n"}A slender young woman with jet black hair, dark skin, and penetrating purplish-blue eyes, wearing a faint smile stuck out her hand. She greeted Dendro. As Jake met her hand with his own, he studied her curiously, and then mumbled:
          "Wait, I know you! I saw you at the mosque! In the city!"{"\n"}
          ...
          {"\n"}A moment later, Jake watched as the mysterious woman moved her hands through her straight black hair. Jake was astonished. <Text style={{ fontFamily: "gelasibro-italic" }}>She has pointed ears! My goodness, she's not human!</Text> She
          rested her head against the top of the booth and continued to sip on her brown drink. She appeared bored or distracted by something, and as Jake continued to glance at her he noticed his heart was beating a little faster than normal.{"\n"}
          {"\n"}"Jake, there's a lot we have to catch you up on, but now, please oblige me with the ability to catch up with my dear old friend, Dendro," Zimmer said. He grinned again, exposing what appeared to be filed down K-9's, then hit Dendro
          ...
          {"\n"}Dendro's old friend stuck up his hand. "One moment. At least let me order you drinks; it's been too long." He proceeded to take out a thick, stubby cigar, and lit with matches on the table. He blew a few smoke rings in the air, then
          signaled for the waiter to come over.{"\n"}
          {"\n"}"Four whiskeys please, fine sir. Your best stuff...," Zimmer began ordering, but Dendro stopped him, directing his eyes at Jake.{"\n"}
          {"\n"}Zimmer glanced at Jake. "Right, right, he's a youngin'. Well, make it three whiskeys then, and a diet coke with lemon," Zimmer said. "Gotta love that lemon kid!" The waiter nodded and walked towards the bar.{"\n"}
          ...
          {"\n"}Zimmer put his hands through his slicked back silver hair. "It was five years ago when I entered what I like to call my <Text style={{ fontFamily: "gelasibro-italic" }}>exploratory</Text> days...the days after I abruptly left The
          Forces. It was a five-year stint that started off with me bouncing across under-explored regions of The Nestomir," Zimmer said.{"\n"}
          ...
          business. One day my imagination got the best of me, and I left The Forces, without explanation—-I hope one day my brothers in arms can forgive me—-and I embarked on a long journey to locate goods I could transport off-planet, either
          legally, or, let's say, via my own methods."{"\n"}
          {"\n"}
          ...
          was involved in a few IndoOne related enterprises and lived in a private beach house north of our hut."{"\n"}
          ...
          nearly eight hours, we exited the forest path onto a coastal road. We rode on for some time as the thick forest receded away from the coast. I'll never forget, after riding next to the waves, I spotted a rock-bridge, jutting out into the
          sea. It led to what had appeared to be a beach house suspended above the water."{"\n"}
          ...
          {"\n"}"I focused more and more on business to take my mind off of her. And that focused paid off, because the business began to thrive. We built a well-oiled machine. Life was good. For nearly five years my men and I successfully managed
          the operations. And during that time, on a business trip to Naronia, I met Zena, who became a critical part of our operation."{"\n"}
          ...
          {"\n"}"That was all he knew. I asked him about the credibility of his source, but he would not give me any names. From the look in his eye, and the way he said it, I knew he was being truthful.. We sat there drinking and smoking for a
          while. I thought about you, Dendro, and my team. I knew I had to do something, and Delpher's day was only a few weeks away. We sat there for some time. I argued with Bonjetti that there were still ways to salvage our operation, but once we
          ...
          {"\n"}"But then, after a few more hours of a hopeless hunt, I saw what looked like a Sentauri Beacon I floating to my right, amongst a field of space rocks. The ship was intact, though it had appeared to have taken some blast damage. As I
          ...
          beam to bring you into the cargo bay. I climbed on top of your ship, and I saw you unconscious, but it's dangerous and nearly impossible to open up a stealth fighter from the outside without the right equipment. I was able to confirm your
          vitals were stable. I figured it was best to leave you in the confines of the ship, and get you help on the ground."{"\n"}
          ...
          woke up, just a little disoriented. I've been working on the meeting I had two nights ago, the night we arrived in-system, for two standard years. You have to understand that my own life depended on it. I called you a bunch of times
          throughout the twenty four hours or so after you hit the ground, but you were out cold, until I got to you yesterday, around noon Casablanca time. And I had no way of picking you up. But now we're all here. And the rest you know."{"\n"}
          ...
          {"\n"}Dendro sat back in his seat. The four of them sat for a short while lost in their thoughts.{"\n"}
          ...
          {"\n"}Jake studied Zimmer's face. His canines protruded sharply out of his gums. How did the universe evolve his teeth so similar to a wolf's? Then Zimmer looked at him with a smile.{"\n"}
          {"\n"}"Son, did you know Dendro and I go way back?" He asked.{"\n"}
          {"\n"}Jake nodded. "Dendro mentioned that."{"\n"}
          {"\n"}"We grew up together in the Lower Palisades. The notorious neighborhood in Sector 8 of Jade City, the capital city of Naronia, located on the gray continent of Nubibus. It is well known that The Palisades pop out some of the baddest
          ...
          {"\n"}"I'll never forget how my young mind changed that day...when Kliggins walked us through <Text style={{ fontFamily: "gelasibro-italic" }}>The Essence of Data</Text>." Zimmer took another puff of his cigar, blew out more white smoke,
          and continued, "That guy was such a character, remember Dendro?{"\n"}
          {"\n"}Dendro nodded.{"\n"}
          {"\n"}"Before Kliggins started any of his schpiels, he made a highly specific brew of Kashmirian Kahve, sipped on it, then made an obnoxiously loud 'ahhhh' noise in front of the class."{"\n"}
          ...
          {"\n"}Kliggins took a few steps forward, then skipped and danced around the room in his metal toed boots. The men half howled with laughter, half looked at each other in disbelief—they were always blown away by their teacher's pedagogical
          antics.{"\n"}
          ...
          {"\n"}"Now say it with me, class." And the men repeated with him in unison:{" "}
          ...
          more efficiently." Kliggins paused, then went on. "The two almighty data structures we'll discuss in this benefit lesson, that are utterly essential to us as coders, and that were explicitly designed for the realm of software, are{" "}
          ...
          {"\n"}Kliggons went on, "This is similar to how we use dictionaries in programming. A dictionary is a data structure that allows us to look up information by name. The beautiful programming language of Python has built in support for
        ...
        <Text style={BookStyles.bookFont}>
          ...
          <Text style={{ color: "#0C2443", fontFamily: "code" }}>
            'meatball': <Text style={{ fontFamily: "gelasibro-italic" }}></Text>"a piece of meat"<Text style={{ fontFamily: "gelasibro-italic" }}></Text>
          </Text>
          . Note, we must add a comma in back of our value, if our dictionary is to contain more than one key-value pair."{"\n"}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          we must assign our list to a new variable, or else we can not access it later."{"\n"}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}Kliggins spotted a student asleep in the back of his classroom. He threw the chalkboard eraser at the shaved head. "Lito, wake your flat stinkin' buttocks up." Lito snapped to attention. Kliggins paused for a second, then continued.
          "So, how do you think we access the value of a list? Well how would you reference a specific item in <Text style={{ fontFamily: "gelasibro-italic" }}>any</Text> list, Henderson? Say if you were communicating with me?"{"\n"}
          {"\n"}"Uh. Sir. I don't know. I would." The trainee thought for a moment. "I guess I'd tell you which one in the list to look at."{"\n"}
          {"\n"}"That's very clear, Henderson," Kliggins said, derisively.{"\n"}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}The men shook their heads, side-to-side.{"\n"}
          ...
          list of your friends. This is a great example howa coder could represent this information, your friend list, using a list of dictionaries."{"\n"}
        ...
        <Text style={BookStyles.bookFont}>
          "The code here may look confusing. But I'm simply formatting it in a way that makes it take up more vertical space so that it doesn't run too far across the right of the board, which is something we'd like to do in a code editor—it's easier
          on the eyes. What we're looking at here is a list, and it's three items are dictionaries. Like this." Kliggins sketched another line on the bottom of the board to make the code more conceptually clear.
        </Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}"Now there is one more thing I'd like to discuss in this lesson. Coders are obsessed"—-Kliggins bent down and slapped the floor with both hands—-" absolutely obsessed, with how much effort is required for our computer to find, add,
          and delete elements from a specific data structure. For example, when we work with dictionaries and lists, coders will often think long and hard about these types of things."{"\n"}
          ...
          {"\n"}With that, Dendro stood up and said: "Anyways, men, and women, it's getting past my bedtime. Zimmer, you and I will coordinate what is required tomorrow. It was good to see both of you. Jake let's head back."{"\n"}
