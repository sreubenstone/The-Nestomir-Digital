    ...
    return (
      <View>
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}“Who, me?” Dendro grunted, still focused on the papers in front of him. “Watched too many war movies. I grew up in The Lower Palisades, a rough neighborhood in Moon City, the capital city of Naronia. Not much opportunity for work or
          anything good, especially as a Tier II race. Walked into the recruiter’s office one day. Guess that was it.”{"\n"}
          ...
          {"\n"}Dendro tapped on a green button positioned on the top left center of the ship's joystick. Immediately, underneath the console in front of Dendro, a keyboard popped out and a text editor program appeared on the display. Dendro began
          using the keyboard arrows to tinker with something on the screen.{"\n"}
          ...
          and my loyalty is to the Ld’Shab, to the Utma.” Dendro’s yellow eyes looked at Jake intensely, then he grinned.{"\n"}
          ...
          society since the inception of our civilization. Our religion, <Text style={{ fontFamily: "gelasibro-italic" }}>the Ld'Shab</Text>, is based on the critical dogma that <Text style={{ fontFamily: "gelasibro-italic" }}>the Utma</Text> was
          brought into existence by <Text style={{ fontFamily: "gelasibro-italic" }}>Our Creator</Text> to guide our learning process for the purpose of bettering our world.”{"\n"}
          {"\n"}Jake scratched his head.{"\n"}
          {"\n"}Dendro lifted his hands off the keys and turned to Jake. "We believe that an intelligent being's purpose is to learn. Learning is our goal, as both individuals and as a species. To say it more authentically, the Ld’Shab religion
          ...
          discovered the precursors to what we refer to as <Text style={{ fontFamily: "gelasibro-italic" }}>physically tangible</Text> Utma Benefits. These are benefits that sentient beings are awarded when studying critical components of the Utma.”
          {"\n"}
          {"\n"}"What does that mean?" Jake asked, perplexed.{"\n"}
          {"\n"}"It means as we study a certain holy Ld'Shab Curriculum—<Text style={{ fontFamily: "gelasibro-italic" }}>The Holy Curricula</Text>. Under certain conditions which our spiritual teachers have honed over hundreds of years, we are
          granted metaphysical powers. Powers beyond the explanation of the physical world. Powers granted by the Utma itself.{"\n"}
          ...
          {"\n"}“A computer uses a special component called a transistor, which is a tiny electrical on and off switch, to do everything it needs to do. From playing video games to crunching numbers, at the end of the day it's just an arrangement—a
          very complex arrangement of these electrical switches firing together that makes a computer tick. At the lowest levels of the computer, at the transistor level, the computer only understands these ONs and OFFs. We use a number system called{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>binary</Text> to describe this language of ON and OFF. It consists of only two digits: zeroes and ones, or ON’S and OFF’S,” Dendro said. “You can think of it as a certain type of morse code –
          a simple pattern, but by using math, we can represent and process almost any type of information we want quite efficiently.{"\n"}
          ...
          on your planet for inventing the language, actually stumbled upon Python during a Naronian government experiment. The language’s designs were left on his desk by a Naronian agent in an attempt to study how Python would proliferate out of
          the galaxy. Guido took credit for its creation,” Dendro stated.{"\n"}
          ...
          {"\n"}"To put it simply, there is a translation process. Another program can break down our text statements, digest them, and convert them into zeros and ones. We sometimes refer to this program as a compiler, or an interpreter. We can
          spend a lot of time studying the innards of these translation tools, and the hardware itself. It is important to note that coding, the art of organizing text-based instructions for the computer, is still only a subset of understanding the
          computer.”{"\n"}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          data type, called a <Text style={{ fontFamily: "gelasibro-italic" }}>boolean</Text>. This is a data type that is meant to represent if something is true, or false. A boolean variable will store either a{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>True</Text> or <Text style={{ fontFamily: "gelasibro-italic" }}>False</Text> value. Booleans come in handy in coding, as the most complex of problems often can be simplified down to a variety
          of true and false statements. For example, there are many times our programs may want to do something like…if this is <Text style={{ fontFamily: "gelasibro-italic" }}>true</Text>, then perform this action, or if this is{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>false</Text>, then perform this other action. There are other data types we can discuss later on,” Dendro said.{"\n"}
          ...
          {"\n"}“It is a very special object from our galaxy. An orb containing stardust from the <Text style={{ fontFamily: "gelasibro-italic" }}>Teqwequar Nebula</Text>, the nebula our religion believes to be the singularity point of creation. An
          object that we control through the Utma must contain this stardust. The <Text style={{ fontFamily: "gelasibro-italic" }}>dusted orb</Text>, as we sometimes call it, enables you to{" "}
