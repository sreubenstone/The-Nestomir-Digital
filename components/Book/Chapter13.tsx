    ...
    return (
      <View>
        ...
        <Text style={BookStyles.bookFont}>
          It was 10:50 AM when Jake woke up the next morning. He slid up and moaned as he pressed down on his pecs and shoulders. <Text style={{ fontFamily: "gelasibro-italic" }}>Why am I this sore?</Text> He played through the training in his mind.{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>I guess that axe was heavier than I realized.</Text> He pulled himself out of bed, took a quick shower, and threw on a light blue soccer t-shirt and a pair of Adidas shorts, his chain, and
          dropped the beeper that he left on his desk into his pocket.{"\n"}
          {"\n"}When he got into the kitchen, he saw a familiar note on the wall.{"\n"}
          {"\n"}
          <Text style={{ textAlign: "center" }}>Out again. Back later. Don't wander off. Keep beeper on you. — D</Text>
          {"\n"}
          {"\n"}
          ...
          <Text style={{ fontFamily: "gelasibro-italic" }}>Zena beeped me? Cafe Langostina? How am I supposed to find Rue D'azilal? And what on Earth does she mean by women's restroom, cityscape?</Text> He walked to the far end of the room, beyond
          Dendro's bed, and glanced out the hexagonal window. What else was he going to do today? <Text style={{ fontFamily: "gelasibro-italic" }}>I guess that's where I'm headed,</Text> he thought.{"\n"}
          {"\n"}A man behind a street cart gave him directions. "Thank you, sir," Jake replied. Ten minutes later, after walking through several side streets, crossing a wide boulevard, and then navigating a large car-filled rotary, he stepped onto{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>Rue D'azilal</Text>. <Text style={{ fontFamily: "gelasibro-italic" }}>Cafe Langostina</Text> was on the far corner of the block.{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>There she is</Text>. He entered the crowded restaurant and walked past the maitre'D, heading for the back in search of the bathrooms. He soon spotted the woman's lavatory, walked up to the
          door, turned his head both ways to ensure nobody was looking, then entered.{"\n"}
          {"\n"}Jake glanced around the restroom. "What am I looking for in here...a <Text style={{ fontFamily: "gelasibro-italic" }}>cityscape</Text>, Zena beeped?" But then he saw the painting. A watercolor of a European city he didn't quite
          recognize sat across from the toilet, stretching from the floor to the ceiling. <Text style={{ fontFamily: "gelasibro-italic" }}>That looks like a city to me</Text>. He walked up to it. He tried placing his hands on the landscape, speaking
          to it, even reciting his name. But nothing happened. <Text style={{ fontFamily: "gelasibro-italic" }}>What am I supposed to do?</Text> Then he took the beeper from his pocket and held it in front of the canvas. Almost immediately, he heard
          the sound of an airlock opening. The painting shot upwards into a slot on the ceiling, and once again, Jake had a hard time believing his eyes. He was standing in the corner of a room that had at least thirty alien creatures inside of it.
          But he was no longer inside a cafe; he was standing inside of some kind of indoor garden. Palm trees surrounded a long rectangular marble pool in the center of the room. Glittering stars and other celestial objects were painted across the
          navy ceiling. <Text style={{ fontFamily: "gelasibro-italic" }}>What is this place?</Text>
          {"\n"}
          {"\n"}He watched as a group of the aliens—and to his great surprise—a few humans, sat on their knees beside the pool. They appeared to be praying as they dipped their hands into the water.{" "}
          ...
          {"\n"}"Hey there!" She spoke as he approached. She stuck out her hand. "Please, have a seat."{"\n"}
          ...
          {"\n"}"<Text style={{ fontFamily: "gelasibro-italic" }}>Enlightened</Text> systems?" Jake asked.{"\n"}
          {"\n"}"Yes. The Naronian Senate began to imperialize new star systems a few thousand years ago, at the beginning of the Affagi Era," Zena said. "These out-of-galaxy settlements we refer to as{" "}
          ...
          <Text style={{ fontFamily: "gelasibro-italic" }}>humans</Text>. We use the term <Text style={{ fontFamily: "gelasibro-italic" }}>Enlightened</Text> because these people now know the truth that they are not alone in the universe."{"\n"}
          {"\n"}"There are humans...that are aware...of your culture? Jake asked. "I know that Dendro mentioned something about a <Text style={{ fontFamily: "gelasibro-italic" }}>settled system</Text> but I was too caught up in the chaos of the
          journey to even think about it until I got to Casablanca."{"\n"}
          ...
          {"\n"}Jake thought about what Zena had just told him. Then he asked: "But, why would you leave the Nestomir to come to Earth?"{"\n"}
          ...
          agriculture," Zena answered.{"\n"}
          {"\n"}"That's insane. <Text style={{ fontFamily: "gelasibro-italic" }}>It really is."</Text> Jake looked around the room again. "Not only are we not alone, but we are also sharing the planet with a select group of humans who know about your
          existence," Jake stated.{"\n"}
          {"\n"}"That is correct. The members of Enlightened cities are very proud, to the extent they have almost generated a culture of their own," Zena said. She slid an empty mug over to him. "Here, have some tea," she said. She began to pour the
          steaming liquid into his cup.{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>What other things do I not know about the universe?</Text> He thought. He played through the week's events in his mind as he sipped on his chamomile flavored drink.{"\n"}
          {"\n"}"Well, this week has been something. Hasn't it?" Zena said, a few moments later.{"\n"}
          {"\n"}Jake's eye's dilated. "Yes. To be here. In this place. To learn about your world. It's been..." Jake paused. "It's been overwhelming, to say the least."{"\n"}
          ...
          {"\n"}Jake was excited and relieved to hear he might be going home soon, but he was still a bit skeptical. "That's good to hear. But what if the Naronian Forces hold onto <Text style={{ fontFamily: "gelasibro-italic" }}>Spectator One</Text>
          , the law that Dendro mentioned, and demand that has to continue holding onto me, for the time being?" Jake asked.{"\n"}
          {"\n"}"Let's not think about that—we'll have to deal with that scenario if it emerges, but we see absolutely no reason for The Forces to want to hold onto you for any longer. We believe the immediate threat has been suppressed. But the rule
          must be obeyed; we must get permission to bring you home. We are very confident we soon will." She took another sip of her tea, and her facial expression noticeably perked up. "With all that being said, I have one exciting thing to tell
          you. Zimmer has agreed to take all of us to a very special event taking place over the next two days: <Text style={{ fontFamily: "gelasibro-italic" }}>Morocco's Enlightened Festival</Text>. It's quite serendipitous timing. It takes place
          every five years to celebrate the formation of the Enlightened Commonwealth of Morocco. A few of Zimmer's key contacts will be in attendance. We will leave tomorrow for the event, stay overnight, then we are planning to take you home on
          Wednesday, assuming all goes as planned."{"\n"}
          {"\n"}"We're going to a <Text style={{ fontFamily: "gelasibro-italic" }}>festival</Text>? What will we do there?" Jake asked.{"\n"}
          {"\n"}"Yes, Zimmer has given us the OK. I don't want to spoil it for you, but it will be a fun time. A lot of music, food, and interesting activities," she replied. "I even managed to get us all tickets for an exclusive event taking place
          ...
          {"\n"}"Jupyter Notebook?" Jake asked.{"\n"}
          {"\n"}A waiter passed by carrying a plate with a giant tea kettle and a fish on a plate of lettuce.{"\n"}
          {"\n"}"Yes. The Jupyter Notebook is a tool that lets us easily experiment with our Python code. In The Nestomir, we use a similar notebook tool called the Perimetas Pad, but it's basically the same thing." She took another gulp of tea from
          the porcelain mug. "The Jupyter Notebook is an open source application that runs in your web browser. It allows you to create living and breathing Python notebooks that contain real Python code, visualizations, graphics and text, as well as
          other remarkable things. It is an extraordinary tool to explore, create, and see where different coding ideas take you. Many Earth based professors in academia use Jupyter Notebooks to store their research. It's used all over to explore
          ideas in Python. In fact, you can even search online for famous Jupyter notebooks, download them, and mess around with them."{"\n"}
          ...
          {"\n"}Jake opened up the computer. The alien characters on the keyboard were illuminated by orange light. He scanned the board. "How can I use this, the letters are foreign," Jake said.{"\n"}
          {"\n"}Zena smiled back, and signaled to Jake to put his hands on the keys.{"\n"}
          {"\n"}When Jake put his fingers down, the alien characters disappeared, and were soon replaced by the standard English QWERTY keyboard. "Woah!" Jake shouted.{"\n"}
          ...
          this is browser based, not much will change across different computers, or even operating systems." She pointed at the bottom of the screen. "The nebula icon down here, that's my browser. Open it up. Then put https://jupyter.org/ in the
          ...
          {"\n"}"Yes," Zena responded.{"\n"}
          {"\n"}"So how does it work?" Jake rubbed his hands against the table.{"\n"}
          {"\n"}"The Notebook is broken up into <Text style={{ fontFamily: "gelasibro-italic" }}>cells</Text> —- which are these grey text boxes you see here, where the cursor is blinking. In a Jupyter Notebook, a cell is where we write and organize
          our code," she responded.{"\n"}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}She returned a minute later. "Sorry about that. I had to say hi to a friend," Zena said. "But as I was washing my face with the basin water, I was thinking about our dojo training yesterday—it's so critical that we try to build new
          ...
          {"\n"}"Yea. It kind of like a practice pad," Jake said.{"\n"}
          ...
          {"\n"}Jake thought for a moment. "That's an interesting quote."{"\n"}
          {"\n"}She looked at him intently. "You know it might be interesting to pick a small idea and try and spin it up on The Jupyter Notebook. Nothing mind boggling. Just something to help make things click based on your learnings to date."{"\n"}
          ...
          {"\n"}"I once came up with the idea to create a multiplayer game for iPhone and Android. But I had no idea how to code so that idea died quickly," Jake said.{"\n"}
          {"\n"}"Ah. That's interesting. A multiplayer game could have a lot of potential. We can explore game development a bit later, but we need to build up more of your fundamentals to get to that level. You will get there —- I promise. Allow me
          to suggest something simpler for today," Zena said.{"\n"}
          {"\n"}"Ok," Jake responded.{"\n"}
          ...
          {"\n"}"Ok, great. Yes, this will be a collaborative process," Zena added.{"\n"}
          ...
          implement this process when they begin new projects. Sometimes we refer to this outlining method as pseudo-coding. Pseudocoding is the procedure of jotting down the steps of our program using English, or the equivalent. It does not require
          us to use Python syntax just yet. Can you take a stab at outlining the steps in English?" Zena responded.{"\n"}
        ...
        <Text style={BookStyles.bookFont}>Zena looked at Jake's work. "You are correct. But please allow me to make some modifications." She slid the computer over to her and added in her version of the pseudocode in a new cell below Jake's.</Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}"Ok, got it," Jake replied. "Now I see how this thing is like a real notebook. We can use regular English and Python in the same place."{"\n"}
          ...
          deliver a fully polished product, we can design this app as a <Text style={{ fontFamily: "gelasibro-italic" }}>function</Text> first. So take a try knowing this point. And it's ok to think out loud. In fact it's better, so I can help. Don't
          worry about messing up. Coding is all about making mistakes and adapting quickly. Even the masters mess up on their first, second, and third attempts. It's just part of coding. And don't forget to toggle the central dropdown bar back into{" "}
          ...
          {"\n"}"I'll see what I can do," Jake replied. He toggled the central dropdown menu back to Python, then put the cursor in the new notebook cell. He thought for a few moments, then spoke out loud, "So step one is to enter the month we were
          born. You said we can use a function for this attempt today. We are entering in a month. So what does that mean? That's an input right? So can I start by creating a function with one input? Like I did yesterday in the dojo? He kept his eyes
          on the screen. He wrote in the function header by defining a function named <Text style={{ color: "#0C2443", fontFamily: "code" }}>getHoroscope</Text>,and giving it one input parameter named{" "}
          <Text style={{ color: "#0C2443", fontFamily: "code" }}>month</Text>.
        </Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          "Yes, excellent. This is how we define a function with one input," Zena replied. "What's next?"{"\n"}
          ...
          {"\n"}"You are correct, we need to define our horoscopes. Let me ask—-what might be the process you would use, say on paper, to store and retrieve an assortment of horoscopes organized by month?" Zena asked.{"\n"}
          {"\n"}Jake squinted his eyes as he thought about the question. "I'd have a list of some sort, that stores each month and its corresponding horoscope. Then look up the specific horoscope that corresponded in the list to that month? Something
          like that," Jake said.{"\n"}
          ...
          {"\n"}"A data structure. A dictionary!" Jake said enthusiastically.{"\n"}
          ...
          {"\n"}"In the function's code block? Ok. I think I remember the syntax. The open and closed brackets, the keys and values. Give me a minute to think of some good ones." {"\n"}
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}"Yes." Jake nodded. "So what's next?"{"\n"}
          ...
          {"\n"}"That is correct. We will work through this together, don't fret. We need to use our input, <Text style={{ fontFamily: "gelasibro-italic" }}>month</Text>, to look up the correct value in our dictionary. Do you remember how to access
          the <Text style={{ fontFamily: "gelasibro-italic" }}>value</Text> of a specific <Text style={{ fontFamily: "gelasibro-italic" }}>key</Text> in a dictionary?" Zena asked.{"\n"}
          {"\n"}"Uh. I think so. You write in the name of the dictionary, then place the key name in quotes inside of brackets next to it," Jake replied. He added another line of code to the function.
        </Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}"Well what do you think? Be confident with your intuition," Zena said.{"\n"}
          {"\n"}"No way," Jake said. "Can we really use the parameter directly?"{"\n"}
          {"\n"}Zena's eyes nudged him toward the cell block.{"\n"}
          ...
          {"\n"}Jake modified his code slightly at the bottom.
        </Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          "Well done. I'm telling you, always trust your gut," Zena said. "Some of this stuff is more obvious then it appears. It is only the intimidation of learning something new that often gets in the way."{"\n"}
          ...
          <Text style={{ color: "#0C2443", fontFamily: "code" }}>
            <Text style={{ fontFamily: "gelasibro-italic" }}></Text>return<Text style={{ fontFamily: "gelasibro-italic" }}></Text>
          </Text>{" "}
          keyword at the end of his function's code block. Then he defined a new variable, and set it equal to the output of his <Text style={{ color: "#0C2443", fontFamily: "code" }}>getHoroscope</Text> function, passing in his real birth month,
          June, as the input argument.
        </Text>
        <View style={GlobalStyles.flexCenter}>
        ...
        <Text style={BookStyles.bookFont}>
          ...
          {"\n"}
          {"\n"}
          {"\n"}"That's my horoscope! I don't think I'll be getting a new pet until next year! Your code appears to be operational. Congratulations, this is excellent work...you just built a working piece of software," Zena said.{"\n"}
          {"\n"}"Thanks," Jake responded, his cheeks blushing slightly. "That's amazing."{"\n"}
          ...
          function. Python can help us do some serious stuff," Zena said with a smile. She checked her beeper. "Ah. Crap. "This was fun. I wish I could stay, but I have to run." She reached into her bag and pulled out a book with a thick leather
          binding, and placed it in front of Jake. <Text style={{ fontFamily: "gelasibro-italic" }}>The Learning Doctrines</Text> was printed in gold underneath a set of alien lettering. "Books are powerful," she said. "This is a key work of Ld'Shab
          philosophy. It's helped guide how our society learns, studies, and creates. This is only <Text style={{ fontFamily: "gelasibro-italic" }}>Volume One</Text>, but feel free to glance through it. This edition has been translated into English."
          She stood up, sliding her computer into her bag. "You can stay here as long as you'd like. And keep that beeper on you! I will see you later." With that, she headed for the painting on the front wall.{"\n"}
          {"\n"}Jake watched as the artwork quickly rose up into the ceiling, allowing Zena to step inside the lavatory. She waved to him and then the canvas slid back down in front of her.{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>I wonder where she's going?</Text> As he glanced around the room again to study aliens and humans engaged in social conversations, prayer, and spiritual study, no one paid him any attention.{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>At least I have some peace in here</Text>. He ran his fingers across the binding of the book. <Text style={{ fontFamily: "gelasibro-italic" }}>This thing is old. I wonder what's in it?</Text>{" "}
          He flipped to the first chapter, <Text style={{ fontFamily: "gelasibro-italic" }}>On Learning Discipline</Text>. He scanned through the writing, hunting for interesting phrases and verses. "We must meditate weekly on each lesson in{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>The Holy Curricula</Text>, even if we feel we have mastered the concepts." <Text style={{ fontFamily: "gelasibro-italic" }}>Interesting</Text>, he thought. He perused a few other passages:{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>The Birth of Naronian Culture</Text>, <Text style={{ fontFamily: "gelasibro-italic" }}>The Function</Text>,and{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>Daily Ld'Shab Spiritual Practice</Text>. <Text style={{ fontFamily: "gelasibro-italic" }}>They have fire-dancing rituals? </Text>
          {"\n"}
          {"\n"}Four hours had passed by the time he received a message from Dendro informing him to come home to have dinner. <Text style={{ fontFamily: "gelasibro-italic" }}>I must head back, but let me finish this up quick.</Text> He spent five
          minutes finishing up a segment on <Text style={{ fontFamily: "gelasibro-italic" }}>The Investigation of Spirit Walks</Text>, then headed for the painting, book in hand. He walked through the cafe, back onto the street, and as he sauntered
          back to Tangiers, he wondered how he could ever return home knowing what he did now.
        </Text>
      </View>
    );
  }
