...
“Yes. And through our history of studying The Utma, we’ve learned that she incentivizes us to learn specific subjects she feels will better society long term.”
...
“The Utma Benefit of Basic Flight is tied to one of the Ld’Shab foundational Benefit Teachings called Zenshi Hedoku.” It is a short story recapping a famous spiritual teacher from our world. Dendro said. 
 
“Let’s begin, and listen carefully. I have not been trained as a spiritual teacher. But every military operative in the forces knows the core lessons, well enough. My memory of the lessons will have to do, for now.”, Dendro said.
 
“Let’s begin.”, Dendro said, staring at the sky.
 
“Five thousand years ago a famous Naronian Philosopher, named Zenshi Hedoku, was sitting by a river in the now lost Naronian continent of Akkrecious. He was pondering a specific set of writings of the First Ancients that he stumbled upon in the monastery.
 
The writings spoke of a prediction; the creation of calculation machines. They spoke of crude counting devices. Things that could add. Things that could subtract. There were no sketches. The First Ancients spoke of a need for switching devices to accomplish these calculation tasks. Not all of the writing made sense. But the idea intrigued Zenshi. Six thousand years later in Zenshi’s time, not much had been made of it. Wars got in the way.
 
As Zenshi stared at the river, something overcame him. He ran up to the monastery. It was built into the mountain. He walked into the communal bathroom and looked at the newly installed faucets by the local iron workers guild. He stared for a moment. A few fellow monks passed him. 
 
He ran back to his room. He took out his ink and papyrus parchment. And then he sketched.
`;

const ChapterTwo2 = `He described in his notes that a faucet was essentially a gate, a switch. He believed that there may be a way to use faucets to create a simple calculation machine. He remembered that the First Ancients mentioned that some kind of switch would be needed to accomplish this feat. He ran the idea by a few of his fellow monks. They asked if he had been smoking too much of his tobacco pipe.
 
He thought about it some more over the next few days. He felt he could make something out of his idea, and counter what his fellow monks believed. But it was a passing inspiration. He struggled to design anything useful. He was particularly flummoxed by how we could open and close the faucets without his hands, which was essential for his designs. But nothing was particularly effective, or practical, and the frustration shows in his writings. He ended up going back to his famous studies of forest animals and trees.
 
And that's the story.
 
“So the guy Zenshi, or whatever, never did anything else with the idea?”
 
“No, he never did anything else with it.
 
Jake thought for a moment.
 
“Jake you must now complete your Utma Benefit Challenge, so we can get out of here. 
...
“Yes, it’s an experience for everyone. Their first time in the Utma Meditative State, generated by the Deep Universe”, Dendro said.
...
YOU HAVE RECEIVED A LESSON.
 
ZENSHI HEDOKU.
 
THIS CHALLENGE TESTS THY UNDERSTANDING. 
 
WHAT WAS ZENSHI HEDOKU’S INTENSION WITH FAUCETS?


Jake stared at the projected text hanging in space. “Woah”. “Dendro, how do I answer? What if I get it wrong?...Dendro?

There was no response. “Dendro? ####. He can’t hear me in here.”

Jake breathed through his teeth. 

“Uhh. Hello? How many tries do I get?”, Jake asked.

No response.

“What if I mess up? Do I get any help?”, Jake asked nervously.

No response.

“Uhhm. Well. I guess I will attempt an answer. The faucet. This guy, Zenshi. A monk. Nature dude. Read writings. Glancing at water. He was curious. Ran up to the bathroom. He was intrigued by the faucet. Why, umm. Because he thought a faucet could act as a switch?

The space where the yellow text was projected flashed a dark red.

“Crap, that was wrong? I guess I can try again.”, Jake muttered.

“But he did believe the faucet was a switch. At least that’s what Dendro’s story told. Hmm. Maybe The Utma is looking for context?. Zenshi believed a faucet could act as a switch. He was interested in this because the First Ancients believed a switch was needed to create a calculation machine.” 


UTMA BENEFIT TEACHING COMPLETE. BASIC FLIGHT BENEFIT ATTAINED. 
 
PLEASE SET YOUR DESTINATION.


Jake looked. “Woah. Guess it liked that answer. Umm. Seattle, Washington.”

The scene began to zoom out quickly. The ocean, the sky, the graphic, he was whirling through, turned into nothing. Then his eyes opened. And he could see Dendro again.

“Woah, that was trippy.” Jake exclaimed. 
...
“You should be getting feedback from The Utma. That’s how it works. The Utma cares about your understanding, not the specific words you use to answer. Hmm. I am almost positive this is exactly what the first challenge demands. I remember clearly from training”, Dendro said. 
...
“Well Jake. You receive a distinct marking whenever you complete a Benefit Teaching with The Utma. The Benefit Lesson you just passed was for Zenshi Hedoku. Your benefit, Basic Flight, will stay with you forever. 
...
export { ChapterTwo1, ChapterTwo2 };
