    ...
    return (
      <View>
        ...
        <Text style={BookStyles.bookFont}>
          The hum of Casablanca’s morning prayer radiated through the streets as the cyberpunk alarm clock on his night table hit 9:34 a.m. He pulled himself up and looked through the blinds. The sun was already shining brightly. His mind shifted to
          a nebulous memory of a dream from last night. It centered around data and its different shapes, dictionaries, lists, and other digital formations moving through the wires of the Earth. He threw himself out of the bed, put on his silver
          chain, jeans, and a t-shirt. When he entered the kitchen he saw a note scribbled on the kitchen wall.{"\n"}
          {"\n"}
          ...
          {"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>Great. I’m alone in a foreign city again</Text>, Jake thought.{"\n"}
          {"\n"}He walked over the metal-paneled floor to examine the globe on the night table. When he studied the glowing surface, he noticed that the outlines of Earth's continents were not just glowing faintly, but small pink ripples moved from
          unique points on the map and radiated outwards in peculiar patterns. <Text style={{ fontFamily: "gelasibro-italic" }}>What is this thing?</Text> There were a few undulations emerging from where he thought Morocco should be, but when he
          looked at the continent of North America, the internal area was dark. He spun the globe with his hand a few times, and on one of the revolutions, he could have sworn he saw a faint blue ring pulse outwards from exactly where he imagined
          Grapefield was located. <Text style={{ fontFamily: "gelasibro-italic" }}>Odd</Text>. Two more pulses radiated from the spot in quick succession. <Text style={{ fontFamily: "gelasibro-italic" }}>What do those mean?</Text>
          {"\n"}
          {"\n"}He stood there for a moment examining the globe, then the thought of spicy lamb kebabs hit him. It was time to get breakfast with the few Moroccan <Text style={{ fontFamily: "gelasibro-italic" }}>Dirhams</Text> Dendro left on the
          counter. As he exited the building and turned onto Tangier’s street, there was a warm squeeze on his right bicep. It was a slender woman, wearing a headband, and aviator glasses with silver lenses.{"\n"}
          {"\n"}"I was wondering where you were," Zena said.{"\n"}
          {"\n"}“What-what are you doing here?” Jake stammered.{"\n"}
          {"\n"}"It’s breakfast time, and I am responsible for you today,” she said. “Zimmer is caught up with some business and Dendro is busy.”{"\n"}
          {"\n"}"Oh,” Jake said. “I was just going out to grab some food.”{"\n"}
          ...
          {"\n"}"What are you waiting for? Let's go!" Zena called out over her shoulder. She showed no signs of slowing down. Jake jogged to catch up to her.{"\n"}
          {"\n"}They continued walking down a narrow boulevard until they turned onto a road running parallel with the coastline, called <Text style={{ fontFamily: "gelasibro-italic" }}>Rue D’ Antoine</Text>. They walked until they reached a
          restaurant with a white sign that read: <Text style={{ fontFamily: "gelasibro-italic" }}>Bid Farha Cafe</Text>. Patrons sat at outdoor tables drinking coffee from white porcelain mugs and eating a variety of interesting looking foods off of
          wooden plates. The inside appeared to contain a large bakery.{"\n"}
          ...
          {"\n"}Jake explained to her his desire to get home, the tale of how he left school early that day, the shots fired from the factory, his learnings, and his growing intrigue with Zena’s world. The waiter placed two wooden plates of eggs and
          olives and two double espressos on the table. Zena took a few bites, then looked at him as he took down a gulp of his food.{"\n"}
          {"\n"}“How do you explain what happened on the rink?" Zena said. "Yes, I know about the fight."{"\n"}
          {"\n"}Jake wasn’t expecting the question. He swallowed a scoop of eggs and olives slowly. "It just kind of happened. I saw these characters floating across my vision. It was like... I don't know... It wasn't Jake... I wasn't myself," he
          said. “It was bizarre.”{"\n"}
          {"\n"}“Hm. You know that is extremely peculiar. I’ve never heard of anyone doing that without passing the proper Utma lessons. Maybe there's more to you than meets the eye?” Zena said.{"\n"}
          {"\n"}“Maybe.” Jake grinned.{"\n"}
          ...
          soul I think as compared to the rest of my family members. I desired freedom, and exploration, and leading something of my own. At least that was my gut feeling when I was growing up. My sister was different. She studied galactic economics
          and now has a family on Tarvezius, and a good job at a bank. But that was her. And this is me.{"\n"}
          ...
          <Text style={{ fontFamily: "gelasibro-italic" }}>The Soul Learned</Text>, by Atilka Souri,” Zena said.{"\n"}
          ...
          {"\n"}Zena took another swig of her coffee. “Yes, every few weeks over long band,” Zena replied. “They are doing well. They want me to come home.”{"\n"}
          ...
          {"\n"}“Ridiculously good,” he replied as a few pieces of egg fell onto his lap.{"\n"}
          ...
          one, sat an etching of a pink rose overlaid on top of an alien-like glyph. As Zena picked them up, Jake noticed their bottoms were made of a dense, cloudy metal.{"\n"}
          ...
          {"\n"}They climbed up and over the rockpile and entered a much smaller, isolated cove. The beach they had come from was no longer visible. Zena placed the boards down onto the sand, and then did something Jake did not expect. She took off
          her headband, undid her ponytail, and her long, shiny, black hair rolled down over her shoulders and back. As she undressed, Jake could see she was wearing a bathing suit underneath.{"\n"}
          ...
          carefully onto the board. But his body slid directly across it, there was no momentum transfer whatsoever, and he spun into the water headfirst. It was as if the board was stuck in the water. But that didn't make any sense.{"\n"}
          ...
          {"\n"}She walked to the shoreline and dropped her board flat on top of the water. She stood with her feet on the sand, closed her eyes and began breathing deeply as if she were meditating, then stepped forward, gently placing her right foot
          on the slightly curved acrylic surface, and then her left. Small waves crashed around her feet. She stood still on the foreign object for a minute with her hands extended in front of her.{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>What the heck is she doing?</Text>
          {"\n"}
          {"\n"}The board began to move forward, slowly at first.{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>How in the world is it moving?</Text>
          {"\n"}
          {"\n"}Zena bent her knees to allow herself to remain balanced. And then she began to sing as the spirit board began to accelerate.{"\n"}
          {"\n"}“Lavanà, hadmarà, my maker, thank you for my spirit and my mind. Thank you for the heart beats of the beings around me. I am here now, with you, as I’ve always been,” she sang in a sullen tune.{"\n"}
          {"\n"}
          ...
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>How do I find my path? What does that mean? Why doesn’t she answer me?</Text>
          {"\n"}
          {"\n"}He closed his eyes and listened to the waves, but it was hard to focus on anything knowing Zena was watching him. But slowly the sound of the ocean calmed him. <Text style={{ fontFamily: "gelasibro-italic" }}>Just relax.</Text> He
          thought of launching the rocket at Pond Park last Fall. He thought of Nassir. He imagined sitting down at his dinner table eating hot noodles with his mom and brother. His thoughts shifted to the rink. Then to hovering axes. Then to Dylan
          Jenkins. Then his mind sifted deeper, to thoughts of his father. He felt confused and angry, but he forced the image out of his head.{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>What is my path?</Text>
          {"\n"}
          {"\n"}He thought of his speaker project, then of code. He felt slightly more connected to the object beneath him. He opened his eyes, but nothing was moving. He closed them again.{" "}
          <Text style={{ fontFamily: "gelasibro-italic" }}>Is this a joke?</Text> He forced himself to take it seriously. <Text style={{ fontFamily: "gelasibro-italic" }}>I can do this.</Text> He thought of Python, variables, control flow, ecosystems
          of open-source creation. <Text style={{ fontFamily: "gelasibro-italic" }}>There must be something here.</Text> He clenched his jaw and imagined being born a different person.{"\n"}
          {"\n"}And then a weird thought popped into his head: a group of alien workers constructing a new world out of a void. A new world? A void? Where did that come from? He opened his eyes and the board began to move. It accelerated forward
          without his control.{"\n"}
          {"\n"}
          <Text style={{ fontFamily: "gelasibro-italic" }}>Whoa. Now how do I slow it down!?</Text> A large wave broke ten feet ahead of him, and he sped towards it, out of control. He collided with the energetic water, catapulted into the air, and
          smashed back down into the sea once again. His face rose back to the surface.{"\n"}
          {"\n"}“Crap,” he muttered. He saw Zena, grinning and signaling to come back to the shore. He paddled back, leaving the board in the water behind him.{"\n"}
